...
Create a new database in pgAdmin (preferably named ArtBay) and add the following to your .env file (normally
...
access for the TAs):
    ...
    DB_NAME=ArtBay || <postgres_db_name>
...
At the root folder of the app (./ArtBay) six more scripts are present with the following roles:
